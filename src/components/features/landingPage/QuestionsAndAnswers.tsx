...
const QuestionAndAnswer = () => {
  ...
  return (
    <section className="px-4 sm:px-6 py-20 sm:py-28 lg:py-[140px]">
          ...
          <div>
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className="lg:text-[44px] md:text-[28px] lg:w-177.25 md:w-85.75 lg:leading-15 md:leading-[130%] font-semibold ">
                    {faq.question}
                  </span>
                </button>
